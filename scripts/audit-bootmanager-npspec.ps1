...
$evidenceRules = @(
    ...
    @{ Pattern = 'NPSPEC-BOOTDESIGN-0009'; Status = 'Teilweise integriert'; Evidence = 'icons.c: semantische O(1)-Tokens, zentral registrierte und geprüfte Iconressourcen, Cache-Diagnose, DLU-Skalierung, Theme-Tint, 2-Bit-AA und Fallback; allgemeiner SVG-Renderer fehlt' },
    ...
    @{ Pattern = 'NPSPEC-BOOTCONTROL-SLIDER-0001'; Status = 'Teilweise integriert'; Evidence = 'controls.c: geprüfter Integerbereich, Schrittweite, Clamp, Locked/Readonly, Track/Füllung/Knob und Diagnostik hostgetestet; produktiver Einstellungswert, Pointer-Drag und BIOS-Anbindung fehlen' },
    @{ Pattern = 'NPSPEC-BOOTCONTROL-CHECKBOX-0001'; Status = 'Teilweise integriert'; Evidence = 'controls.c: Checked/Unchecked/Indeterminate, Toggle-/Lock-Regeln und typisierter Renderer; produktiver UEFI-Verwendungsfall und BIOS-Anbindung fehlen' },
    ...
    @{ Pattern = 'NPSPEC-BOOTCONTROL-TOOLTIP-0001'; Status = 'Teilweise integriert'; Evidence = 'ui.c/main.c: genau ein zentraler Tooltip nach 750 ms Fokusruhe, Safe-Area-Positionierung, Theme/High Contrast, kein Fokus-/Input-Capture und sofortiges Ausblenden bei Eingabe, Dialog oder Context Menu; Motion/Touch und BIOS-Anbindung fehlen; QEMU-Frame visuell geprüft' },
    ...
    @{ Pattern = 'NPSPEC-BOOTDIALOG-0010'; Status = 'Teilweise integriert'; Evidence = 'motion.c: Dialog Fade/Scale und Reduced-Motion-Fallback hostgetestet; die neue UEFI-Dialoginstanz wird derzeit atomar statt zeitlich animiert geöffnet' },
