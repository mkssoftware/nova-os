...
#define NOVA_BOOT_ARCH_X86_64         2u
#define NOVA_BOOT_FLAG_FRAMEBUFFER    0x00000001u

typedef enum nova_boot_verification_state {
    NOVA_BOOT_VERIFICATION_UNKNOWN = 0,
    NOVA_BOOT_VERIFICATION_STRUCTURE_VALIDATED = 1,
    NOVA_BOOT_VERIFICATION_INTEGRITY_VERIFIED = 2,
    NOVA_BOOT_VERIFICATION_SIGNATURE_VERIFIED = 3,
    NOVA_BOOT_VERIFICATION_POLICY_AUTHORIZED = 4
} nova_boot_verification_state_t;

typedef enum nova_secure_boot_state {
    NOVA_SECURE_BOOT_UNKNOWN = 0,
    NOVA_SECURE_BOOT_DISABLED = 1,
    NOVA_SECURE_BOOT_ENABLED = 2,
    NOVA_SECURE_BOOT_SETUP_MODE = 3
} nova_secure_boot_state_t;

enum {
    NOVA_BOOT_SECURITY_FIRMWARE_STATE_KNOWN = 0x00000001u,
    NOVA_BOOT_SECURITY_ELF_BUILD_ID_VALID = 0x00000002u,
    NOVA_BOOT_SECURITY_NKI_CRC32_VALID = 0x00000004u,
