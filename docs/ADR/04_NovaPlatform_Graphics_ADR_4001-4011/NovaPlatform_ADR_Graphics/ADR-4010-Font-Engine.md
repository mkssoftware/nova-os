...
Dieses ADR beschreibt die Architekturentscheidung für **Font Engine** innerhalb der Nova Graphics Engine (NGE).
...
Dieses ADR beeinflusst alle Module, die **Font Engine** verwenden.
