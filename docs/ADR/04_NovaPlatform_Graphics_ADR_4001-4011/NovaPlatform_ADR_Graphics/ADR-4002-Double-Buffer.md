# ADR-4002: Double Buffer Rendering
...
Dieses ADR beschreibt die Architekturentscheidung für **Double Buffer Rendering** innerhalb der Nova Graphics Engine (NGE).
...
Dieses ADR beeinflusst alle Module, die **Double Buffer Rendering** verwenden.
