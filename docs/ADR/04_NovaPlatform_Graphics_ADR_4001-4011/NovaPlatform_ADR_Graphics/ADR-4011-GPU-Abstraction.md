# ADR-4011: GPU-Abstraktionsschicht
...
Dieses ADR beschreibt die Architekturentscheidung für **GPU-Abstraktionsschicht** innerhalb der Nova Graphics Engine (NGE).
...
Dieses ADR beeinflusst alle Module, die **GPU-Abstraktionsschicht** verwenden.
