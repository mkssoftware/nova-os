...
Dieses ADR beschreibt die Architekturentscheidung für **Animationssystem** innerhalb der Nova Graphics Engine (NGE).
...
Dieses ADR beeinflusst alle Module, die **Animationssystem** verwenden.
