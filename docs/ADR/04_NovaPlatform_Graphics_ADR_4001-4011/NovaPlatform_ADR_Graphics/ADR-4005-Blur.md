...
Dieses ADR beschreibt die Architekturentscheidung für **Blur-Engine** innerhalb der Nova Graphics Engine (NGE).
...
Dieses ADR beeinflusst alle Module, die **Blur-Engine** verwenden.
