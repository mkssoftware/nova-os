...
Dieses ADR beschreibt die Architekturentscheidung für **Alpha-Blending** innerhalb der Nova Graphics Engine (NGE).
...
Dieses ADR beeinflusst alle Module, die **Alpha-Blending** verwenden.
