# ADR-4008: Bildformate und Decoder
...
Dieses ADR beschreibt die Architekturentscheidung für **Bildformate und Decoder** innerhalb der Nova Graphics Engine (NGE).
...
Dieses ADR beeinflusst alle Module, die **Bildformate und Decoder** verwenden.
