...
Dieses ADR beschreibt die Architekturentscheidung für **Vektorgrafik (SVG/NVG)** innerhalb der Nova Graphics Engine (NGE).
...
Dieses ADR beeinflusst alle Module, die **Vektorgrafik (SVG/NVG)** verwenden.
