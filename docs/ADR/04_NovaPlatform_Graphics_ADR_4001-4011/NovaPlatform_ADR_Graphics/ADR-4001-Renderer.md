# ADR-4001: Nova Graphics Renderer
...
Dieses ADR beschreibt die Architekturentscheidung für **Nova Graphics Renderer** innerhalb der Nova Graphics Engine (NGE).
...
Dieses ADR beeinflusst alle Module, die **Nova Graphics Renderer** verwenden.
