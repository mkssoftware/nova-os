...
Dieses ADR definiert die Architekturentscheidung für **Theme Engine** innerhalb des Nova UI Frameworks.
...
Dieses ADR beeinflusst alle Module, die **Theme Engine** verwenden.
