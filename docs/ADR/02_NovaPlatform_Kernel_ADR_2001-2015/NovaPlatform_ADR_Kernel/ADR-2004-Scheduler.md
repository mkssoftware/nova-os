# ADR-2004: Präemptiver Scheduler
...
Dieses Dokument definiert die Architekturentscheidung für **Präemptiver Scheduler** innerhalb des Nova-Kernels.
...
Diese Entscheidung betrifft alle Kernelmodule, die mit **Präemptiver Scheduler** interagieren.
