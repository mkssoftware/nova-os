# ADR-2010: Kernel Service Manager
...
Dieses Dokument definiert die Architekturentscheidung für **Kernel Service Manager** innerhalb des Nova-Kernels.
...
Diese Entscheidung betrifft alle Kernelmodule, die mit **Kernel Service Manager** interagieren.
