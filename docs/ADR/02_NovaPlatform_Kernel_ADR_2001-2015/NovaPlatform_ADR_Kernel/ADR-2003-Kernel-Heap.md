...
Dieses Dokument definiert die Architekturentscheidung für **Kernel-Heap** innerhalb des Nova-Kernels.
...
Diese Entscheidung betrifft alle Kernelmodule, die mit **Kernel-Heap** interagieren.
