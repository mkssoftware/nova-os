...
Dieses Dokument definiert die Architekturentscheidung für **Kernel-Modul-Loader** innerhalb des Nova-Kernels.
...
Diese Entscheidung betrifft alle Kernelmodule, die mit **Kernel-Modul-Loader** interagieren.
