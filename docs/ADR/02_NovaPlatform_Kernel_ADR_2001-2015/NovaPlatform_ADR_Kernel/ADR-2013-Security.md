...
Dieses Dokument definiert die Architekturentscheidung für **Sicherheitsmodell** innerhalb des Nova-Kernels.
...
Diese Entscheidung betrifft alle Kernelmodule, die mit **Sicherheitsmodell** interagieren.
