# ADR-2007: Interrupt-Architektur
...
Dieses Dokument definiert die Architekturentscheidung für **Interrupt-Architektur** innerhalb des Nova-Kernels.
...
Diese Entscheidung betrifft alle Kernelmodule, die mit **Interrupt-Architektur** interagieren.
