...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTDESIGN-0004 |
...
Diese ADR beschreibt die Architekturentscheidung für **Kontrastabhängige Oberflächen** innerhalb des Design- und Accessibility-Systems des NovaOS-Bootmanagers.
