# ADR-BOOTDESIGN-0005 – Helles und dunkles Boot-Theme

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTDESIGN-0005 |
| Kategorie | NovaOS Bootmanager / Design |
| Status | Angenommen |
| Version | 1.0 |
| Datum | 2026-08-03 |
...
Diese ADR beschreibt die Architekturentscheidung für **Helles und dunkles Boot-Theme** innerhalb des Design- und Accessibility-Systems des NovaOS-Bootmanagers.
