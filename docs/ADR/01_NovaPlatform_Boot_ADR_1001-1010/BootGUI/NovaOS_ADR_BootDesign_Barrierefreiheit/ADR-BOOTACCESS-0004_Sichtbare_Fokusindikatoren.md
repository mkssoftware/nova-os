...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTACCESS-0004 |
...
Diese ADR beschreibt die Architekturentscheidung für **Sichtbare Fokusindikatoren** innerhalb des Design- und Accessibility-Systems des NovaOS-Bootmanagers.
