...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTACCESS-0002 |
...
Diese ADR beschreibt die Architekturentscheidung für **Hochkontrastmodus** innerhalb des Design- und Accessibility-Systems des NovaOS-Bootmanagers.
