...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTACCESS-0003 |
...
Diese ADR beschreibt die Architekturentscheidung für **Skalierbare Schrift- und Bedienelementgrößen** innerhalb des Design- und Accessibility-Systems des NovaOS-Bootmanagers.
