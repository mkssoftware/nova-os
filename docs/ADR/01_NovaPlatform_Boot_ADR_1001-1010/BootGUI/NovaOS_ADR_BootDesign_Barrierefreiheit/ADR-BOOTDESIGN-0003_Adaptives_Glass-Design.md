...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTDESIGN-0003 |
...
Diese ADR beschreibt die Architekturentscheidung für **Adaptives Glass-Design** innerhalb des Design- und Accessibility-Systems des NovaOS-Bootmanagers.
