# ADR-BOOTACCESS-0005 – Keine ausschließlich farbbasierten Statusinformationen

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTACCESS-0005 |
...
Diese ADR beschreibt die Architekturentscheidung für **Keine ausschließlich farbbasierten Statusinformationen** innerhalb des Design- und Accessibility-Systems des NovaOS-Bootmanagers.
