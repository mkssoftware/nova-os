...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTDESIGN-0001 |
...
Diese ADR beschreibt die Architekturentscheidung für **Ableitung vom Nova Design Language** innerhalb des Design- und Accessibility-Systems des NovaOS-Bootmanagers.
