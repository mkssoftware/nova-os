...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTRESOURCE-0006 |
...
Diese ADR beschreibt die Architekturentscheidung für **Vorverarbeitete und validierte Ressourcen** innerhalb des Ressourcen- und Asset-Managements des NovaOS-Bootmanagers.
