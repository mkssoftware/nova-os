# ADR-BOOTRESOURCE-0007 – Ressourcenkompression

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTRESOURCE-0007 |
...
Diese ADR beschreibt die Architekturentscheidung für **Ressourcenkompression** innerhalb des Ressourcen- und Asset-Managements des NovaOS-Bootmanagers.
