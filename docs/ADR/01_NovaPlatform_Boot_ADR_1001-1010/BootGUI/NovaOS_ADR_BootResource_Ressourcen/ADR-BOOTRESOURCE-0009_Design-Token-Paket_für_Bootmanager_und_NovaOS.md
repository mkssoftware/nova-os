...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTRESOURCE-0009 |
...
Diese ADR beschreibt die Architekturentscheidung für **Design-Token-Paket für Bootmanager und NovaOS** innerhalb des Ressourcen- und Asset-Managements des NovaOS-Bootmanagers.
