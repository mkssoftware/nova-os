# ADR-BOOTRESOURCE-0001 – Eigenes Boot-Asset-Paketformat

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTRESOURCE-0001 |
...
Diese ADR beschreibt die Architekturentscheidung für **Eigenes Boot-Asset-Paketformat** innerhalb des Ressourcen- und Asset-Managements des NovaOS-Bootmanagers.
