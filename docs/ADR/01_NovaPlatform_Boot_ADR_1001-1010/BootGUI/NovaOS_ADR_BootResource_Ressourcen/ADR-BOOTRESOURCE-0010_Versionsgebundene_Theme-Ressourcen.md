...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTRESOURCE-0010 |
...
Diese ADR beschreibt die Architekturentscheidung für **Versionsgebundene Theme-Ressourcen** innerhalb des Ressourcen- und Asset-Managements des NovaOS-Bootmanagers.
