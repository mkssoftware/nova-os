...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTRESOURCE-0003 |
...
Diese ADR beschreibt die Architekturentscheidung für **PNG als Rastergrafikformat** innerhalb des Ressourcen- und Asset-Managements des NovaOS-Bootmanagers.
