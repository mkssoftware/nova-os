# ADR-BOOTRESOURCE-0005 – Eingebettete Schriftarten

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTRESOURCE-0005 |
...
Diese ADR beschreibt die Architekturentscheidung für **Eingebettete Schriftarten** innerhalb des Ressourcen- und Asset-Managements des NovaOS-Bootmanagers.
