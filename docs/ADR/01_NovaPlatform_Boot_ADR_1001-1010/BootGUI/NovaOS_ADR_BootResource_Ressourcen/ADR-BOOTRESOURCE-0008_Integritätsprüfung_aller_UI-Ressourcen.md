# ADR-BOOTRESOURCE-0008 – Integritätsprüfung aller UI-Ressourcen

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTRESOURCE-0008 |
...
Diese ADR beschreibt die Architekturentscheidung für **Integritätsprüfung aller UI-Ressourcen** innerhalb des Ressourcen- und Asset-Managements des NovaOS-Bootmanagers.
