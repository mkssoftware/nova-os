# ADR-BOOTRESOURCE-0002 – Statisches Einbetten kritischer Ressourcen

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTRESOURCE-0002 |
...
Diese ADR beschreibt die Architekturentscheidung für **Statisches Einbetten kritischer Ressourcen** innerhalb des Ressourcen- und Asset-Managements des NovaOS-Bootmanagers.
