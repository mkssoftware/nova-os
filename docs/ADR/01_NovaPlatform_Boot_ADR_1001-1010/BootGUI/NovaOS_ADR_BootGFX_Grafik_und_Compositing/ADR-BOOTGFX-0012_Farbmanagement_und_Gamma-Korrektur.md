# ADR-BOOTGFX-0012 – Farbmanagement und Gamma-Korrektur

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTGFX-0012 |
...
Diese ADR definiert die Architekturentscheidung für **Farbmanagement und Gamma-Korrektur** innerhalb der Boot-Grafikpipeline von NovaOS.
