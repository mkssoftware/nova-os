# ADR-BOOTCONTROL-0004 – Eingabeunabhängige Aktivierungsaktionen

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTCONTROL-0004 |
...
Diese ADR beschreibt die Architekturentscheidung für **Eingabeunabhängige Aktivierungsaktionen** innerhalb des Control-Frameworks des NovaOS-Bootmanagers.
