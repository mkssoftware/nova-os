...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTCONTROL-0005 |
...
Diese ADR beschreibt die Architekturentscheidung für **Wiederverwendbare Komponenten statt fest gezeichneter Oberflächen** innerhalb des Control-Frameworks des NovaOS-Bootmanagers.
