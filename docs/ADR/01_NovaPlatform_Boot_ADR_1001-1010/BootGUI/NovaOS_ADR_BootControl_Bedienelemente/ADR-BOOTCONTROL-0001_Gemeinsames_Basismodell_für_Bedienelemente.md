...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTCONTROL-0001 |
...
Diese ADR beschreibt die Architekturentscheidung für **Gemeinsames Basismodell für Bedienelemente** innerhalb des Control-Frameworks des NovaOS-Bootmanagers.
