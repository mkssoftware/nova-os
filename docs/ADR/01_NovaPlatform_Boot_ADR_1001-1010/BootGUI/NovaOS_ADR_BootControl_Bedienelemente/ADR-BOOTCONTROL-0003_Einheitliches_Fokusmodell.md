...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTCONTROL-0003 |
...
Diese ADR beschreibt die Architekturentscheidung für **Einheitliches Fokusmodell** innerhalb des Control-Frameworks des NovaOS-Bootmanagers.
