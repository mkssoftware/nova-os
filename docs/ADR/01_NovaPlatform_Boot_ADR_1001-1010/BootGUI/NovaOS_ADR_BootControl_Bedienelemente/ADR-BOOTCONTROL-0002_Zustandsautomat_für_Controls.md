...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTCONTROL-0002 |
...
Diese ADR beschreibt die Architekturentscheidung für **Zustandsautomat für Controls** innerhalb des Control-Frameworks des NovaOS-Bootmanagers.
