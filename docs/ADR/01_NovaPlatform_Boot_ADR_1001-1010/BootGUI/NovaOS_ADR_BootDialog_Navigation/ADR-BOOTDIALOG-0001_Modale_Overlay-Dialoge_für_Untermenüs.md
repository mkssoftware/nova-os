...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTDIALOG-0001 |
...
Diese ADR beschreibt die Architekturentscheidung für **Modale Overlay-Dialoge für Untermenüs** innerhalb der Dialog- und Navigationsarchitektur des NovaOS-Bootmanagers.
