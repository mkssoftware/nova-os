...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTDIALOG-0004 |
...
Diese ADR beschreibt die Architekturentscheidung für **Fokusbindung innerhalb modaler Dialoge** innerhalb der Dialog- und Navigationsarchitektur des NovaOS-Bootmanagers.
