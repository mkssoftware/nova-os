...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTDIALOG-0003 |
...
Diese ADR beschreibt die Architekturentscheidung für **Glass-Design mit adaptivem Fallback** innerhalb der Dialog- und Navigationsarchitektur des NovaOS-Bootmanagers.
