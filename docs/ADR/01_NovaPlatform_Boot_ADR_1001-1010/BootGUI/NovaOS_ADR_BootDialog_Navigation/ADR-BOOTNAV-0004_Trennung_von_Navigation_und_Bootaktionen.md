...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTNAV-0004 |
| Kategorie | NovaOS Bootmanager / Navigation |
| Status | Angenommen |
| Version | 1.0 |
| Datum | 2026-08-03 |
...
Diese ADR beschreibt die Architekturentscheidung für **Trennung von Navigation und Bootaktionen** innerhalb der Dialog- und Navigationsarchitektur des NovaOS-Bootmanagers.
