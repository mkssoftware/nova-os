# ADR-BOOTDIALOG-0005 – Verschachtelung von Dialogen begrenzen

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTDIALOG-0005 |
...
Diese ADR beschreibt die Architekturentscheidung für **Verschachtelung von Dialogen begrenzen** innerhalb der Dialog- und Navigationsarchitektur des NovaOS-Bootmanagers.
