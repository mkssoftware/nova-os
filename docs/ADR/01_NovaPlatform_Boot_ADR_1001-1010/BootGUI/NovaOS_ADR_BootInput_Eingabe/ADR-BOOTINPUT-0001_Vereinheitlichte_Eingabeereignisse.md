...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTINPUT-0001 |
...
Diese ADR definiert die Architekturentscheidung für **Vereinheitlichte Eingabeereignisse** innerhalb des Eingabesystems des NovaOS-Bootmanagers.
