# ADR-BOOTINPUT-0004 – Pointer-Capture

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTINPUT-0004 |
...
Diese ADR definiert die Architekturentscheidung für **Pointer-Capture** innerhalb des Eingabesystems des NovaOS-Bootmanagers.
