...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTINPUT-0005 |
...
Diese ADR definiert die Architekturentscheidung für **Eingabefokus und Fokusnavigation** innerhalb des Eingabesystems des NovaOS-Bootmanagers.
