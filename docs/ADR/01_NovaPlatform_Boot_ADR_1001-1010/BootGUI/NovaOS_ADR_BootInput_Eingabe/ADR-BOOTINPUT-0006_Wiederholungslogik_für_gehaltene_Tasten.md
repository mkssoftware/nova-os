# ADR-BOOTINPUT-0006 – Wiederholungslogik für gehaltene Tasten

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTINPUT-0006 |
...
Diese ADR definiert die Architekturentscheidung für **Wiederholungslogik für gehaltene Tasten** innerhalb des Eingabesystems des NovaOS-Bootmanagers.
