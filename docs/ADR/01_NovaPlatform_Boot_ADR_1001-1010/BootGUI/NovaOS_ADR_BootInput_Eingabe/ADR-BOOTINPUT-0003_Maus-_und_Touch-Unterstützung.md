# ADR-BOOTINPUT-0003 – Maus- und Touch-Unterstützung

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTINPUT-0003 |
...
Diese ADR definiert die Architekturentscheidung für **Maus- und Touch-Unterstützung** innerhalb des Eingabesystems des NovaOS-Bootmanagers.
