# ADR-BOOTINPUT-0007 – Geräteunabhängige Eingabekoordinaten

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTINPUT-0007 |
...
Diese ADR definiert die Architekturentscheidung für **Geräteunabhängige Eingabekoordinaten** innerhalb des Eingabesystems des NovaOS-Bootmanagers.
