# ADR-BOOTTEXT-0001 – Vektorbasierte Schriftwiedergabe

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTTEXT-0001 |
...
Diese ADR beschreibt die Architekturentscheidung für **Vektorbasierte Schriftwiedergabe** innerhalb des Text- und Lokalisierungssystems des NovaOS-Bootmanagers.
