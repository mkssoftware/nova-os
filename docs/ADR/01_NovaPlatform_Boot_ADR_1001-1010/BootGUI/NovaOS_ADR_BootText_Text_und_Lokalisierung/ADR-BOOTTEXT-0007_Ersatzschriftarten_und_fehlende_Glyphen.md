# ADR-BOOTTEXT-0007 – Ersatzschriftarten und fehlende Glyphen

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTTEXT-0007 |
...
Diese ADR beschreibt die Architekturentscheidung für **Ersatzschriftarten und fehlende Glyphen** innerhalb des Text- und Lokalisierungssystems des NovaOS-Bootmanagers.
