# ADR-BOOTTEXT-0005 – Lokalisierbare Bootoberfläche

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTTEXT-0005 |
...
Diese ADR beschreibt die Architekturentscheidung für **Lokalisierbare Bootoberfläche** innerhalb des Text- und Lokalisierungssystems des NovaOS-Bootmanagers.
