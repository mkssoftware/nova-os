# ADR-BOOTTEXT-0003 – UTF-8 als Textkodierung

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTTEXT-0003 |
...
Diese ADR beschreibt die Architekturentscheidung für **UTF-8 als Textkodierung** innerhalb des Text- und Lokalisierungssystems des NovaOS-Bootmanagers.
