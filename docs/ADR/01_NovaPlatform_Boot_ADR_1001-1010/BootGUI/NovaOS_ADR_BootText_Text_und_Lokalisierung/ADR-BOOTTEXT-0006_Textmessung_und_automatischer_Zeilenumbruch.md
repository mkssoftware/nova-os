# ADR-BOOTTEXT-0006 – Textmessung und automatischer Zeilenumbruch

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTTEXT-0006 |
...
Diese ADR beschreibt die Architekturentscheidung für **Textmessung und automatischer Zeilenumbruch** innerhalb des Text- und Lokalisierungssystems des NovaOS-Bootmanagers.
