# ADR-BOOTTEXT-0002 – Vorgerasterter Glyphen-Atlas als Fallback

| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTTEXT-0002 |
...
Diese ADR beschreibt die Architekturentscheidung für **Vorgerasterter Glyphen-Atlas als Fallback** innerhalb des Text- und Lokalisierungssystems des NovaOS-Bootmanagers.
