...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTMOTION-0007 |
...
**Reduzierte Bewegung bei eingeschränkter Leistung** wird als verbindlicher Bestandteil des NovaOS-Boot-Motion-Systems implementiert und sowohl im Software-Renderer als auch optional in hardwarebeschleunigten Backends unterstützt.
