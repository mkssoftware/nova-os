...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTMOTION-0002 |
...
**Zentraler Animation-Scheduler** wird als verbindlicher Bestandteil des NovaOS-Boot-Motion-Systems implementiert und sowohl im Software-Renderer als auch optional in hardwarebeschleunigten Backends unterstützt.
