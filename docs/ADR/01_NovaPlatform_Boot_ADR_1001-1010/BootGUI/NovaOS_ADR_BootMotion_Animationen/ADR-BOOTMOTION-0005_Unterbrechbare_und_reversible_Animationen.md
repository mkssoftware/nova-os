...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTMOTION-0005 |
...
**Unterbrechbare und reversible Animationen** wird als verbindlicher Bestandteil des NovaOS-Boot-Motion-Systems implementiert und sowohl im Software-Renderer als auch optional in hardwarebeschleunigten Backends unterstützt.
