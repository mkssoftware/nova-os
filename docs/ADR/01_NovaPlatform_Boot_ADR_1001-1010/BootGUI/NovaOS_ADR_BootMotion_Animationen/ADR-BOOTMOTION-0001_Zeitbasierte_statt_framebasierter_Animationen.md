...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTMOTION-0001 |
...
**Zeitbasierte statt framebasierter Animationen** wird als verbindlicher Bestandteil des NovaOS-Boot-Motion-Systems implementiert und sowohl im Software-Renderer als auch optional in hardwarebeschleunigten Backends unterstützt.
