...
| Feld | Wert |
|---|---|
| Dokument-ID | ADR-BOOTMOTION-0008 |
...
**Unterstützung von Reduced Motion** wird als verbindlicher Bestandteil des NovaOS-Boot-Motion-Systems implementiert und sowohl im Software-Renderer als auch optional in hardwarebeschleunigten Backends unterstützt.
